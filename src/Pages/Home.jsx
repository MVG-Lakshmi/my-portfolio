...
import Resume from '../Resume/MotamarriVenkataGangadhaLakshmi_resume.pdf'
...
const Home = () => {
    ...
    return (
        <Box>
                ...
                <Flex flexDirection={['column-reverse', 'column-reverse', 'row']} m="auto" justifyContent="space-around" alignItems="center" h="100%">
                    <Box data-aos="fade-down">
                        ...
                        <Box className='content'>
                            <Heading fontSize="3.3em" className='text' data-text="MVG Lakshmi"><span className='themeText'>MVG Lakshmi</span></Heading>
                        </Box>
                        <Text>Am passionate Data Science Enthusiastic.</Text>
                        <HStack className='hireMe' onClick={() => { window.open("https://drive.google.com/file/d/1iRGim7lq4RDN6Sm3wFQCYtXDOIi2fSWh/view?usp=drive_link", '_blank') }}>
                            <a href={Resume} download="MotamarriVenkataGangadhaLakshmi_resume">
            ...
            <Box id="aboutMe">
                ...
                <Flex flexDirection={['column-reverse', 'column-reverse', 'column-reverse', 'row']} alignItems="center" h="100%">
                    ...
                    <Flex data-aos="fade-left">
                        ...
                        <Box>
                            <Text>An ambitious and self-motivated Data Science Enthusiastic with a considerable technical skill who possesses self-discipline and ability to work with minimum of super vision. Able to play a key role in AI, ML, Data Management and Data Analytics. A  quick-learner who can absorb new ideas and can communicate clearly and effectively.</Text>
                        </Box>
                    </Flex>
                </Flex>
            </Box>
                    ...
                    <Box className='form-section'>
                        ...
                        <Flex className='contact-info'>
                            <HStack>
                                ...
                                <Text>mvglakshmi3@gmail.com</Text>
                            </HStack>
                            <HStack>
                                <FaPhoneAlt color="#00a14f" />
                                <Text>+91 63620 33908</Text>
                            </HStack>
                        </Flex>
                        <Flex gap={["10px", "20px", "20px", "40px"]}>
                            <Link href='https://wa.me/qr/DWLNABGJ5G4EF1' target="_blank">
                                <Tooltip label='+91 63620 33908'>
                            ...
                            <Link href='https://www.linkedin.com/in/motamarri-venkata-gangadha-lakshmi-05b2812a0' target="_blank">
                                <Tooltip label='MVG Lakshmi'>
                                    <Box className='social-icons'>
                                        <Box>
                            ...
                            <Link href="https://github.com/MVG-Lakshmi" target="_blank">
                                <Tooltip label='MVG-Lakshmi'>
                                    <Box className='social-icons'>
                                        <Box>
                            ...
                            <Link href="mailto:mvglakshmi3@gmail.com" target="_blank">
                                <Tooltip label='mvglakshmi3@gmail.com'>
                                    <Box className='social-icons'>
                                        <Box>
            ...
            {/* footer */}
            <Flex id='footer'>
                <Text>© Portfolio by MVG Lakshmi | All rights reserved.</Text>
                <Text>Made with 💖 by Lakshmi</Text>
            </Flex>
        </Box >
    )
}
