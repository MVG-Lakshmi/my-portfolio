    ...
    return (
        <Box className='navbar'>
            ...
            <Box display={["none", 'none', 'none', 'flex']} className="nav-options">
                ...
                <Box>
                    <Button onClick={()=>{window.open("https://drive.google.com/file/d/1iRGim7lq4RDN6Sm3wFQCYtXDOIi2fSWh/view?usp=sharing", '_blank')}}><a href={Resume} download="MotamarriVenkataGangadhaLakshmi_resume"><span>Resume</span></a></Button>
                </Box>
                <Box>
